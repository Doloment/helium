...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:rarium_bar', 'xtraores:duragalss_handle', ''},
		{'', 'xtraores:duragalss_handle', ''},
	}
})
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:rarium_bar', 'xtraores:rarium_bar'},
		{'', 'xtraores:duragalss_handle', 'xtraores:rarium_bar'},
		{'', 'xtraores:duragalss_handle', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		...
		{'xtraores:orichalcum_bar', 'xtraores:duragalss_handle', ''},
		{'', 'xtraores:duragalss_handle', ''},
	}
})
minetest.register_craft({
	...
	recipe = {
		{'', 'xtraores:orichalcum_bar', 'xtraores:orichalcum_bar'},
		{'', 'xtraores:duragalss_handle', 'xtraores:orichalcum_bar'},
		{'', 'xtraores:duragalss_handle', ''},
	}
})
